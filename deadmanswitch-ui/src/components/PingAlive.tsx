...
export const PingAlive = () => {
    ...
    return (
        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-xl flex flex-col items-center justify-center">
            <h2 className="text-xl font-bold mb-4 text-white">Activity Check</h2>
            <button
                onClick={handlePing}
                disabled={loading}
                className={`w-32 h-32 rounded-full flex items-center justify-center text-white font-bold text-center border-4 border-white/20 transition-all duration-500 shadow-[0_0_30px_rgba(124,58,237,0.3)] hover:shadow-[0_0_50px_rgba(124,58,237,0.6)] ${loading ? 'bg-gray-600 cursor-not-allowed' : 'bg-purple-600 hover:scale-105 active:scale-95'
                    }`}
            >
